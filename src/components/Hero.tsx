    ...
    <section className="hero" id="home">
      ...
      <div className="container hero__content">
        <div className="hero__badge">
          {portfolio.available && <span className="hero__status" />}
          {portfolio.available ? 'Available for work' : 'Currently unavailable'}
        </div>
        ...
        <h1 className="hero__title">
          ...
          <br />
          <span className="hero__role">{portfolio.role}</span>
        </h1>
